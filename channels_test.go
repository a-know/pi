...
var channelTests = []struct {
...
}{
	{
		...
		input:    []string{"channels", "create", "--name", "test-name", "--type", "slack", "--detail", `{"url":"https://hooks.slack.com/services/T035DA4QD/B06LMAV40/xxxx","userName":"Pixela Notification","channelName":"pixela-notify"}`},
		exitCode: 1,
	},
	{
		name:     "create channel - not specify name",
		input:    []string{"channels", "create", "--channel-id", "test-id", "--type", "slack", "--detail", `{"url":"https://hooks.slack.com/services/T035DA4QD/B06LMAV40/xxxx","userName":"Pixela Notification","channelName":"pixela-notify"}`},
		exitCode: 1,
	},
	{
		name:     "create channel - not specify type",
		input:    []string{"channels", "create", "--channel-id", "test-id", "--name", "test-name", "--detail", `{"url":"https://hooks.slack.com/services/T035DA4QD/B06LMAV40/xxxx","userName":"Pixela Notification","channelName":"pixela-notify"}`},
		exitCode: 1,
	},
	{
		name:     "create channel - not specify detail",
		input:    []string{"channels", "create", "--channel-id", "test-id", "--name", "test-name", "--type", "slack"},
		exitCode: 1,
	},
	{
